...
class OpenAIPlugin(PyttmanPlugin):
    ...
    detect_memory_prompt = ("You have the ability to create memories of your own. "
                            "Determine if this message contains something the user "
                            ...
                            "such as asking you to remind them of something, or a clear "
                            "directive to memorize something. It could also just be a detail "
                            "shared with you, that a human would remember about them. "
                            "If you think you should remember something, Read the content "
                            "of what to remember from the user message and return the memory "
                            "in this format: '[MEMORY]: {your memory content here}'. "
                            "If the message does not match memory making, return 0")

    long_term_memory_prompt = ("\nYou have the ability to create memories of your own. "
                               "The array following this message, contains your long term "
                               "memories with this user. The date and time for when you"
                               "recorded these memories are part of the memory. "
                               "You can use this information to reason about "
                               "how long ago - or how long in the future whatever the "
                               "content of the memory took/takes place. If you see the "
                               "current date and time in the user message, you can "
                               "compare the date time with memories with "
                               "The date time of the messages you've seen until this point. "
                               "Some memories might be of things to happen in the future, "
                               "some might be of things that have happened in the past. "
                               "Be aware of how long ago it was and how long "
